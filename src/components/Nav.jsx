...
const Nav = () => {
    return (
        <nav className="flex justify-center items-center md:mb-10 bg-white px-4">
            <div className="flex justify-between items-start pt-3 pb-4 max-w-[1295px] w-full  border-b border-gray-200">
                <div>
                    <h1 className="font-[600] text-xl leading-8 text-gray-900 mb-2">
                        Welcome
                    </h1>
                    <p className="text-sm font-[400] leading-4 text-gray-600">
